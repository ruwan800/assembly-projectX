...
;orginally written by ruwan jayasinghe
...
cblock	0x20
	...
	txchk,txchk1	;0x33:counter
	msgptr		;0x35:data table reading pointer
	var0,var1,var2,var3,var4,var5;0x36:
	lcdptr		;0x3C:
	tempchar		;0x3D:
	t0,t1,t2,t3,t4,t5,t6,t7,t8,t9;0x3E:
	lowvolt,highvolt	;0x48:
...
msg2	DT	"  Please wait_  few seconds|"		;wait for sampling heart beat
msg3	DT	"Heart beat rate:_  %d.%f bpm|"		;heart beat rate display
...
testfunc:
	...
	BSF	tdatah,0
	MOVF	counth,W
	XORLW	0x06	;888888888888888888888888888888888888888888888888888888888888888888888888888888888888888	
	BTFSS	bitz
	RETURN
	MOVF	countl,W
	XORLW	0x19	;888888888888888888888888888888888888888888888888888888888888888888888888888888888888888	
	BTFSS	bitz
	RETURN
	BSF	tdatah,7
	RETURN
