...
cblock	0x20
	finalmean,finalmeanf	;used to save final result of
	...
	m7,m6,m5,m4,m3,m2,m1,m0	;divide func t8:t7:t6/tcounth:tcountl=[m1.m0]
	txchk,txchk1		;counter
	msgptr		;data table reading pointer
...
lcdinit:
	...
	CALL	cmd
	MOVLW	0x000F	;display ON/OFF control[1,display on,curser off,blinck off]
	CALL	cmd
