...
;Fri 29 Apr 2011 09:28:28 PM IST final edit
;රු:ප්‍ර:ජ:/වි:CTSPER2.1.asm
;this program will support wast amount of pulses within selected period
...
#define	dataen		PORTB,7			;select instruction registry
...
msg0	DT	"HEART RATE COUNT|"			;welcome message
msg1	DT	"error in serial_  transmitting|"
msg2	DT	"_             *|"		;wait for sampling heart beat
